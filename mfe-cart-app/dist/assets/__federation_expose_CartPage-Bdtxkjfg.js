import { importShared } from './__federation_fn_import-Ef78AgsG.js';
...
const { setItems, addItem, clearCart: clearCart$1 } = cartSlice.actions;
...
var R = H.exports;
function dr(s) {
  const m = s.onClick || s.click;
  let g = "bg-blue-600 text-white rounded px-4 py-2 hover:bg-blue-700 ";
  return s.variant === "danger" && (g = "bg-red-500 text-white rounded px-3 py-2 "), s.variant === "ghost" && (g = "bg-gray-200 text-gray-800 rounded px-4 py-2 "), /* @__PURE__ */ R.jsx(
    "button",
    {
      type: "button",
      disabled: s.disabled,
      onClick: m,
      className: g + (s.className || ""),
      style: { marginTop: s.variant === "ghost" ? 2 : 0 },
      children: s.children
    }
  );
}
...
function CartPage(props) {
  ...
  useEffect(() => {
    ...
    const userId2 = token.replace("user-", "") || "guest";
    const cartItems = getCart(userId2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(hr, { children: "Cart" }),
    checkoutMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-600 mb-2", children: checkoutMsg }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y border rounded-lg bg-white", children: [
      items.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "p-4 text-gray-500", children: "empty cart lol" }),
      items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-center", children: [
          item.image && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.image, alt: "", className: "w-12 h-12 object-cover rounded" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-right font-bold mt-4 text-xl", children: [
      "Total: $",
      total.toFixed(2)
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-4 justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(dr, { variant: "ghost", onClick: handleClear, children: "clear" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(dr, { onClick: handleCheckout, children: "Checkout" })
    ] })
  ] });
}

export { CartPage as default, jsxRuntimeExports as j };
