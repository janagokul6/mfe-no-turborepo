...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:false,requiredVersion:'^18.2.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BhMZJInU.js', import.meta.url).href),import:false,requiredVersion:'^18.2.0'}};
